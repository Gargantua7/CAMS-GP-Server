...
open class Snowflake {
    ...
    companion object {
        ...
        protected fun getMaxWorkerId(datacenterId: Long, maxWorkerId: Long): Long {
             ...
             * GET jvmPid
             */
                mpid.append(name.split("@").toTypedArray()[0])
            }
            /*
        ...
        protected fun getDatacenterId(maxDatacenterId: Long): Long {
            ...
            try {
                ...
                if (network == null) {
                    ...
                    id = ((0x000000FF and mac[mac.size - 1].toLong().toInt()
                            or (0x0000FF00 and (mac[mac.size - 2].toLong() shl 8).toInt())) shr 6).toLong()
        ...
        val instance by lazy { Snowflake() }
    }
}
